...
public class ConsumerirTransmitterService extends Service {
    ...
    public void onDestroy() {
        ...
        if (USE_SOCKET
                && null != mSocketServerThread
                && mSocketServerThread.isAlive()) {
    ...
    public void bindQuickSetService() {
        ...
        try {
            ...
            boolean bindResult = (Boolean) ReflectionUtils.invokeMethod(this, "bindServiceAsUser", new Class[] {
                    Intent.class,
